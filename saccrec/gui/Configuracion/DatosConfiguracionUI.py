...
class Ui_Configuracion(object):
    def setupUi(self, Configuracion):
        ...
        self.doubleSpinBox_3 = QtWidgets.QDoubleSpinBox(Configuracion)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, Configuracion):
        ...
        self.label_4.setText(_translate("Configuracion", "Distancia del estimulo del centro (centimetros):"))
