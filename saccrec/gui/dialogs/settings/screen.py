...
from saccrec.consts import SETTINGS_STIMULUS_SCREEN_WIDTH_MINIMUM, SETTINGS_STIMULUS_SCREEN_WIDTH_MAXIMUM, \
    SETTINGS_STIMULUS_SCREEN_HEIGHT_MINIMUM, SETTINGS_STIMULUS_SCREEN_HEIGHT_MAXIMUM
