...
class SDCardImport(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self._input_folder_button.setIcon(QtGui.QIcon(':/common/folder_open.svg'))
        ...
        self._add_studies_button.setIcon(QtGui.QIcon(':/common/add.svg'))
        ...
        self._del_studies_button.setIcon(QtGui.QIcon(':/common/remove.svg'))
        ...
        self._import_button.setIcon(QtGui.QIcon(':/common/upload_file.svg'))
