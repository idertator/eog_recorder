...
class _Channel:
    ...
    def active(self, value: bool):
        _settings.setValue(
            f"Hardware/Channels/{self._index}/Active", "1" if value else "0"
        )
    ...
    def srb1(self, value: bool):
        _settings.setValue(
            f"Hardware/Channels/{self._index}/SRB1", "1" if value else "0"
        )
    ...
    def srb2(self, value: bool):
        _settings.setValue(
            f"Hardware/Channels/{self._index}/SRB2", "1" if value else "0"
        )
    ...
    def settings_command(self) -> str:
        ...
        gain = Gain.from_value(self.gain)
